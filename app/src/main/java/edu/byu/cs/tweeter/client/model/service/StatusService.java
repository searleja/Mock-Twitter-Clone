...
public class StatusService {
    ...
    public void getFeed(User user, int pageSize, Status lastStatus, GetFeedObserver observer) {
    ...
    public void getStory(User user, AuthToken authToken, int pageSize, Status lastStatus, GetStoryObserver observer) {
