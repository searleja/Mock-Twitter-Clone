...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.MainView {
    ...
    @Override
    public void updateFollowing(boolean updateButton) {
        updateFollowButton(updateButton);
    ...
    public List<String> parseURLs(String post) {
        ...
        for (String word : post.split("\\s")) {
            if (word.startsWith("http://") || word.startsWith("https://")) {
                ...
                int index = presenter.findUrlEndIndex(word);
